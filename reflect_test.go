...
import (
	...
	"github.com/mia-platform/jsonschema/examples"
...
func TestReflectFromType(t *testing.T) {
	...
	assert.EqualValues(t, "https://github.com/mia-platform/jsonschema/test-user", s.ID)
...
func prepareCommentReflector(t *testing.T) *Reflector {
	t.Helper()
	r := new(Reflector)
	err := r.AddGoComments("github.com/mia-platform/jsonschema", "./examples")
